...
def classification_report_with_accuracy_score(y_true, y_pred):
    ...
    return a,Pr,Pr1,Re,Re1,F1,F11,HSS_1, HSS_2, GS, TSS, TN, TP, FN, FP
...
#standardization (almost like normalizing)  
   ...
   # classifier_logistic=LogisticRegression(solver= 'lbfgs')
    ...
    a,Pr,Pr1,Re,Re1,F1,F11,HSS_1, HSS_2, GS, TSS, TN, TP, FN, FP=classification_report_with_accuracy_score(y_test, y_pred)
    a_f=a_f+[a]
    Pr_f=Pr_f+[Pr]
    Pr1_f=Pr1_f+[Pr1]
    Re_f=Re_f+[Re]
